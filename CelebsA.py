...
import tempfile
import cv2
from deepface import DeepFace  # Facenet is available in DeepFace
...
BATCH_SIZE = 64
AUTHORIZED_IDS = [2880, 2937]  # Actual person IDs from identity file
MIN_SAMPLES_PER_ID = 5  # Minimum images per authorized user
IMPOSTOR_SAMPLES = 1000  # Number of impostor samples to use
TEST_SIZE = 0.2
SEED = 42
...
def main():
    ...
    history = model.fit(
        ...
        class_weight={0: 1, 1: 5},  # Compensate for residual imbalance
